...
entity GCM_AE_HW_1x1_SubBytes is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GCM_AE_HW_1x1_SubBytes is 
...
attribute shreg_extract : string;
    ...
    component GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
...
begin
    sboxhw_V_U : component GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
