...
entity GCM_AE_HW_1x1_GHASH_H1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GCM_AE_HW_1x1_GHASH_H1 is 
...
attribute shreg_extract : string;
    ...
    signal H_matrix_int_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component GCM_AE_HW_1x1_dot IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        X : IN STD_LOGIC_VECTOR (127 downto 0);
...
begin
    grp_dot_fu_14 : component GCM_AE_HW_1x1_dot
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        X => X_int_reg,
    ...
    H_matrix_int_reg_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            H_matrix_int_reg <= H_matrix;
        end if;
    end process;
