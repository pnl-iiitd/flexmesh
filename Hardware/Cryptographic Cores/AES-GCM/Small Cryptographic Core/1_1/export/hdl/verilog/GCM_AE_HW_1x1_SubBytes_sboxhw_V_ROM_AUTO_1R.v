...
// ==============================================================
`timescale 1 ns / 1 ps
module GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom5); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom6); 
    $readmemh("./GCM_AE_HW_1x1_SubBytes_sboxhw_V_ROM_AUTO_1R.dat", rom7);
end
