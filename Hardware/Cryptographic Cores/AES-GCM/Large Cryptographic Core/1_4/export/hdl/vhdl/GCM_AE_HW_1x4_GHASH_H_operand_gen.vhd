...
entity GCM_AE_HW_1x4_GHASH_H_operand_gen is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GCM_AE_HW_1x4_GHASH_H_operand_gen is 
...
attribute shreg_extract : string;
    ...
    signal grp_GHASH_H4_fu_22_ap_return : STD_LOGIC_VECTOR (127 downto 0);
    signal grp_GHASH_H4_fu_22_ap_ce : STD_LOGIC;
...
begin
    grp_GHASH_H4_fu_22 : component GCM_AE_HW_1x4_GHASH_H4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        X => H_operand_V_read_int_reg,
        H_matrix_3 => H_matrix_3_int_reg,
        ap_return => grp_GHASH_H4_fu_22_ap_return,
        ap_ce => grp_GHASH_H4_fu_22_ap_ce);
    ...
    grp_GHASH_H4_fu_22_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp13, ap_ce_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp13) and (ap_const_logic_1 = ap_ce_reg))) then 
            grp_GHASH_H4_fu_22_ap_ce <= ap_const_logic_1;
        else 
            grp_GHASH_H4_fu_22_ap_ce <= ap_const_logic_0;
        end if; 
    end process;

    ret_V_fu_30_p2 <= (grp_GHASH_H4_fu_22_ap_return xor X_read_reg_40_pp0_iter8_reg);
end behav;
