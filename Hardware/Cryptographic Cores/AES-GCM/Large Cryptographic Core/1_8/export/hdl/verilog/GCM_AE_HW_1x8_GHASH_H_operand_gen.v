...
module GCM_AE_HW_1x8_GHASH_H_operand_gen (
        ap_clk,
        ap_rst,
        X,
        H_operand_V_read,
...
wire   [127:0] grp_GHASH_H8_fu_22_ap_return;
reg    grp_GHASH_H8_fu_22_ap_ce;
...
GCM_AE_HW_1x8_GHASH_H8 grp_GHASH_H8_fu_22(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp13) & (1'b1 == ap_ce_reg))) begin
        grp_GHASH_H8_fu_22_ap_ce = 1'b1;
    end else begin
        grp_GHASH_H8_fu_22_ap_ce = 1'b0;
    end
end
...
assign ret_V_fu_30_p2 = (grp_GHASH_H8_fu_22_ap_return ^ X_read_reg_40_pp0_iter8_reg);

endmodule //GCM_AE_HW_1x8_GHASH_H_operand_gen
