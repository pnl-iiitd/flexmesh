...
entity GCM_AE_HW_1x22_GHASH_H1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of GCM_AE_HW_1x22_GHASH_H1 is 
...
begin
    grp_dot_fu_14 : component GCM_AE_HW_1x22_dot
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        X => X_int_reg,
    ...
    H_matrix_0_int_reg_assign_proc : process (ap_clk)
    begin
    ...
    grp_dot_fu_14_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp12)
    begin
        if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp12)) then 
