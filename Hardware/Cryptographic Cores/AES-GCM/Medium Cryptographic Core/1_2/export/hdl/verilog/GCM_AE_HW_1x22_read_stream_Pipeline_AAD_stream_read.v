...
module GCM_AE_HW_1x22_read_stream_Pipeline_AAD_stream_read (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [57:0] i_2_fu_72;
wire   [57:0] add_ln1145_fu_156_p2;
wire    ap_loop_init;
reg   [0:0] write_flag_0_fu_76;
wire   [1:0] trunc_ln1150_fu_166_p1;
...
always @ (posedge ap_clk) begin
    if ((~(trunc_ln1150_fu_166_p1 == 2'd0) & ~(trunc_ln1150_fu_166_p1 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1027_fu_151_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        blk_V_1_fu_84 <= in_s_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln1150_fu_166_p1 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1027_fu_151_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        blk_V_2_fu_88 <= in_s_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln1150_fu_166_p1 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1027_fu_151_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln1145_fu_156_p2 = (i_2_fu_72 + 58'd1);
...
always @ (*) begin
    ap_condition_187 = ((trunc_ln1150_fu_166_p1 == 2'd0) & (icmp_ln1027_fu_151_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign trunc_ln1150_fu_166_p1 = i_2_fu_72[1:0];

assign write_flag_0_out = write_flag_0_fu_76;

endmodule //GCM_AE_HW_1x22_read_stream_Pipeline_AAD_stream_read
