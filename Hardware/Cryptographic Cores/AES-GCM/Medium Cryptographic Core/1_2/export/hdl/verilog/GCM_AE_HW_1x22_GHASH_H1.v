...
module GCM_AE_HW_1x22_GHASH_H1 (
        ap_clk,
        ap_rst,
        X,
        H_matrix_0,
...
GCM_AE_HW_1x22_dot grp_dot_fu_14(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .X(X_int_reg),
...
always @ (*) begin
    if ((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp12)) begin
...
assign ap_return = grp_dot_fu_14_ap_return;

endmodule //GCM_AE_HW_1x22_GHASH_H1
