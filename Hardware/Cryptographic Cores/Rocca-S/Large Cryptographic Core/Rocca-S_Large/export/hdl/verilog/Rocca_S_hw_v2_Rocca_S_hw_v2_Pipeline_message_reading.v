...
wire   [0:0] icmp_ln396_fu_207_p2;
wire   [0:0] icmp_ln400_fu_234_p2;
...
wire   [63:0] zext_ln408_fu_249_p1;
wire   [63:0] zext_ln401_fu_291_p1;
reg   [31:0] pos_fu_84;
...
wire   [0:0] trunc_ln408_fu_255_p1;
wire   [0:0] trunc_ln401_fu_297_p1;
wire   [31:0] add_ln400_fu_218_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_88 <= 121'd0;
        end else if (((icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln396_fu_207_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_277)) begin
        if ((icmp_ln400_fu_234_p2 == 1'd1)) begin
            grp_convert_endian_128_hw_fu_169_val_r = inp_V_fu_286_p1;
        end else if ((icmp_ln400_fu_234_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_277)) begin
        if (((icmp_ln400_fu_234_p2 == 1'd1) & (trunc_ln401_fu_297_p1 == 1'd0))) begin
            hw_M_0_address0 = zext_ln401_fu_291_p1;
        end else if (((icmp_ln400_fu_234_p2 == 1'd0) & (trunc_ln408_fu_255_p1 == 1'd0))) begin
            hw_M_0_address0 = zext_ln408_fu_249_p1;
        end else begin
            hw_M_0_address0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln400_fu_234_p2 == 1'd0) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln408_fu_255_p1 == 1'd0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln400_fu_234_p2 == 1'd1) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln401_fu_297_p1 == 1'd0)))) begin
        hw_M_0_ce0 = 1'b1;
    end else begin
        hw_M_0_ce0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_277)) begin
        if (((icmp_ln400_fu_234_p2 == 1'd1) & (trunc_ln401_fu_297_p1 == 1'd1))) begin
            hw_M_1_address0 = zext_ln401_fu_291_p1;
        end else if (((icmp_ln400_fu_234_p2 == 1'd0) & (trunc_ln408_fu_255_p1 == 1'd1))) begin
            hw_M_1_address0 = zext_ln408_fu_249_p1;
        end else begin
            hw_M_1_address0 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln400_fu_234_p2 == 1'd0) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln408_fu_255_p1 == 1'd1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln400_fu_234_p2 == 1'd1) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln401_fu_297_p1 == 1'd1)))) begin
        hw_M_1_ce0 = 1'b1;
    end else begin
        hw_M_1_ce0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln396_fu_207_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln400_fu_218_p2 = (pos_fu_84 + 32'd127);
...
always @ (*) begin
    ap_condition_277 = ((1'b0 == ap_block_pp0_stage0) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_285 = ((icmp_ln400_fu_234_p2 == 1'd0) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_288 = ((icmp_ln400_fu_234_p2 == 1'd1) & (icmp_ln396_fu_207_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op30_read_state2 = ((icmp_ln400_fu_234_p2 == 1'd0) & (icmp_ln396_fu_207_p2 == 1'd0));
end

assign grp_convert_endian_128_hw_fu_235_p_din1 = grp_convert_endian_128_hw_fu_169_val_r;

assign grp_fu_176_p4 = {{i_fu_88[9:1]}};

assign hw_M_0_d0 = grp_convert_endian_128_hw_fu_235_p_dout0;

assign hw_M_1_d0 = grp_convert_endian_128_hw_fu_235_p_dout0;

assign i_2_fu_212_p2 = (i_fu_88 + 121'd1);

assign icmp_ln396_fu_207_p2 = ((i_fu_88 == trunc_ln2) ? 1'b1 : 1'b0);

assign icmp_ln400_fu_234_p2 = (($signed(tmp_fu_224_p4) < $signed(23'd1)) ? 1'b1 : 1'b0);
...
assign tmp_fu_224_p4 = {{add_ln400_fu_218_p2[31:9]}};

assign trunc_ln401_fu_297_p1 = i_fu_88[0:0];

assign trunc_ln408_fu_255_p1 = i_fu_88[0:0];

assign trunc_ln628_fu_272_p1 = pos_fu_84[8:0];

assign val_2_fu_244_p1 = input_r_TDATA[127:0];

assign zext_ln401_fu_291_p1 = grp_fu_176_p4;

assign zext_ln408_fu_249_p1 = grp_fu_176_p4;
