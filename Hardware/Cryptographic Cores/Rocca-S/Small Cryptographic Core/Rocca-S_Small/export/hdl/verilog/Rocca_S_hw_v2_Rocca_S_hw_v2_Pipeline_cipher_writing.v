...
reg   [0:0] icmp_ln474_reg_398;
reg    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_state3_io;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln464_fu_196_p2;
...
wire   [0:0] trunc_ln470_fu_223_p1;
reg   [0:0] trunc_ln470_reg_393;
wire   [0:0] icmp_ln474_fu_243_p2;
wire   [8:0] trunc_ln368_fu_254_p1;
reg   [8:0] trunc_ln368_reg_402;
wire   [127:0] tmp_s_fu_274_p4;
wire   [63:0] zext_ln470_fu_217_p1;
...
wire   [120:0] zext_ln464_fu_192_p1;
wire   [8:0] lshr_ln3_fu_207_p4;
wire   [31:0] add_ln474_fu_227_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_98 <= 64'd0;
        end else if (((icmp_ln464_fu_196_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((icmp_ln474_reg_398 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
            p_Val2_s_fu_90 <= p_Result_4_fu_336_p2;
        end else if (((icmp_ln474_reg_398 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln464_fu_196_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln464_fu_196_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln474_fu_243_p2 == 1'd1))) begin
        trunc_ln368_reg_402 <= trunc_ln368_fu_254_p1;
    end
end

always @ (*) begin
    if (((icmp_ln464_fu_196_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln474_reg_398 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln474_reg_398 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln464_fu_196_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln474_fu_227_p2 = (pos_fu_94 + 32'd127);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln474_reg_398 == 1'd0) & (output_r_TREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((icmp_ln474_reg_398 == 1'd0) & (output_r_TREADY == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((icmp_ln474_reg_398 == 1'd0) & (output_r_TREADY == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln474_reg_398 == 1'd0) & (output_r_TREADY == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((icmp_ln474_reg_398 == 1'd0) & (output_r_TREADY == 1'b0));
end

always @ (*) begin
    ap_condition_292 = ((icmp_ln464_fu_196_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln474_fu_243_p2 == 1'd0));
end

always @ (*) begin
    ap_condition_295 = ((icmp_ln464_fu_196_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln474_fu_243_p2 == 1'd1));
end
...
assign grp_convert_endian_128_hw_fu_331_p_din1 = tmp_s_fu_274_p4;

assign hw_C_0_address0 = zext_ln470_fu_217_p1;

assign hw_C_1_address0 = zext_ln470_fu_217_p1;

assign i_4_fu_201_p2 = (i_fu_98 + 64'd1);

assign icmp_ln464_fu_196_p2 = ((zext_ln464_fu_192_p1 < trunc_ln2) ? 1'b1 : 1'b0);

assign icmp_ln474_fu_243_p2 = (($signed(tmp_fu_233_p4) < $signed(23'd1)) ? 1'b1 : 1'b0);
...
assign p_Result_5_fu_288_p5 = {{p_Val2_s_fu_90[511:128]}, {grp_convert_endian_128_hw_fu_331_p_dout0}};
...
assign tmp_fu_233_p4 = {{add_ln474_fu_227_p2[31:9]}};

assign trunc_ln368_fu_254_p1 = pos_fu_94[8:0];

assign trunc_ln470_fu_223_p1 = i_fu_98[0:0];
...
assign zext_ln368_1_fu_326_p1 = grp_convert_endian_128_hw_fu_331_p_dout0;

assign zext_ln368_fu_305_p1 = trunc_ln368_reg_402;

assign zext_ln464_fu_192_p1 = i_fu_98;

assign zext_ln470_fu_217_p1 = lshr_ln3_fu_207_p4;
