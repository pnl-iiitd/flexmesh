...
// ==============================================================
`timescale 1 ns / 1 ps
module Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom5); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom6); 
    $readmemh("./Rocca_S_hw_v2_hw_AES_sboxhw_ROM_AUTO_1R.dat", rom7);
end
